<nav class="main-header navbar navbar-expand navbar-white navbar-light">
   ...
   <ul class="navbar-nav">
    ...
    <ul class="navbar-nav">
      ...
      <?php 
      if(OBIB_MBR_ACCOUNT_ONLINE == TRUE && empty($_SESSION["mbrid"])){
          echo '
          <li class="nav-item">
            <a class="nav-link" href="../opac/loginform.php" role="button" title="'.$navLoc->getText("Login").'">
            <i class="fas fa-sign-in-alt"></i>
            </a>
          </li>
          ';
        } elseif(!empty($_SESSION["userid"]) || !empty($_SESSION["mbrid"])) {
          echo '
          <li class="nav-item">
